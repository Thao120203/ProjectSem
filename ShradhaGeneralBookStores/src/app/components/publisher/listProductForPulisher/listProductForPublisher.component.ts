...
@Component({
  selector: 'app-root',
  templateUrl: './listProductForPublisher.component.html',
  providers: [MessageService, ConfirmationService]

})
export class ListProductForPublisherComponent implements OnInit {
  ...
  ngOnInit() {
    this.activevateRoute.paramMap.subscribe(c=>{
      this._productService.readforpublisher(c.get('id')).then(result=>{
